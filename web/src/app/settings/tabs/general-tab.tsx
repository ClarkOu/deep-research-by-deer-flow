...
export const GeneralTab: Tab = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      <header>
        <h1 className="text-lg font-medium">通用設置</h1>
      </header>
      <main>
        <Form {...form}>
          <form className="space-y-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>搜索計劃的最大步驟數</FormLabel>
                  <FormControl>
                    <Input
                      className="w-60"
                      type="number"
